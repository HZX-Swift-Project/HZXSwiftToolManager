...
extension DDMBProgressHUD {
    ...
    ///   - isCoverNavi: 是否覆盖导航
    ///   - showTime: 显示时长
    public class func showTipMessage(message: String?, view: UIView? = DD_KeyWindow, isMask: Bool = false, isCoverNavi: Bool = true, showTime: Double = defaultHUDShowTime, completeClosure: (() -> Void)? = nil) {
        showTipMessage(message: message, iconName: nil, view: view, isMask: isMask, isCoverNavi: isCoverNavi, showTime: showTime, completeClosure: completeClosure)
    }
    ...
    ///   - isCoverNavi: 是否盖着导航
    ///   - showTime: 提示时长
    public class func showTipMessage(message: String?, iconName: String?, view: UIView? = DD_KeyWindow, isMask: Bool = false, isCoverNavi: Bool = true, showTime: Double = defaultHUDShowTime, completeClosure: (() -> Void)? = nil) {
